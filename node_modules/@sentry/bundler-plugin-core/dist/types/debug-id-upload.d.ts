...
export declare function createDebugIdUploadFunction({ assets, ignore, logger, releaseName, dist, handleRecoverableError, sentryHub, sentryClient, sentryCliOptions, rewriteSourcesHook, freeDependencyOnSourcemapFiles, }: DebugIdUploadPluginOptions): (buildArtifactPaths: string[]) => Promise<void>;
